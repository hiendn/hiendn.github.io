...
Hien Nguyen is a Senior Lecturer at the University of Queensland specializing in optimization algorithms for statistical and machine learning models, as well as inferential tools for such models. His research has been applied in various fields including neuroimaging, agriculture, genetics, proteomics, economics, and public health. Prior to his current position, he held the role of Senior Lecturer at La Trobe University and was a member of the Statistical Society of Australia (SSA) Vic Council from 2019 to 2021.

From 2017 to 2020, Hien Nguyen served as an ARC DECRA Fellow, contributing to research in his field. Additionally, he has been appointed as the Statistical Computing Editor for the Australian and New Zealand Journal of Statistics (ANZJS) from 2019 to 2023, demonstrating his expertise and commitment to scholarly publications. Hien Nguyen currently holds the positions of SSA Queensland President, along with being the Book Reviews Editor and Technical Editor for ANZJS.

In his free time, Hien Nguyen enjoys spending time with his three cats, Nyx, Penelope, and Beau.
